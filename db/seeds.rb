...
Resource.create(name: "Washington State Democratic Party", link: "http://www.wa-democrats.org/")
Resource.create(name: "Washington State Republican Party", link: "https://wsrp.org/")
